...
public class Vehicle03BodyScript : MonoBehaviour {
	...
	void Awake()
	{
		bs = PlayerPrefs.GetInt ("V03B");
		ss = PlayerPrefs.GetInt ("V03S");
		es = PlayerPrefs.GetInt ("V03E");
		cs = PlayerPrefs.GetInt ("V03C");
	}

	void Start()
	{
		onNew = PlayerPrefs.GetInt ("V03N");
		if (onNew == 0) {
			cs = 4;
			PlayerPrefs.SetInt ("V03N", 1);
		}
	...
	void FixedUpdate()
	{
		...
		PlayerPrefs.SetInt ("V03B", bs);
		PlayerPrefs.SetInt ("V03E", es);
		PlayerPrefs.SetInt ("V03S", ss);
		PlayerPrefs.SetInt ("V03C", cs);
