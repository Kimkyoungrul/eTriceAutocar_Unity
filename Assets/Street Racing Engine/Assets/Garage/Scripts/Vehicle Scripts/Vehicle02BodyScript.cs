...
public class Vehicle02BodyScript : MonoBehaviour {
	...
	void Start()
	{
		...
		onNew = PlayerPrefs.GetInt ("V02N");
		if (onNew == 0) {
			cs = 1;
			PlayerPrefs.SetInt ("V02N", 1);
		}
	 ...
	 void FixedUpdate()
	{
		...
		if(bs == 0)
		{
			BodyPartsGameobjects.bumper01.SetActive (true);	BodyPartsGameobjects.bumper02.SetActive (false); BodyPartsGameobjects.bumper03.SetActive (false);sp1 = 200;
		}	else sp1 = 0;
		if(bs == 1)
		{
		...
		if(ss == 1)
		{
			BodyPartsGameobjects.spoiler01.SetActive (false);	BodyPartsGameobjects.spoiler02.SetActive (true); BodyPartsGameobjects.spoiler03.SetActive (false);sp2 = 200;
		}	else sp2 = 0;
		if(ss == 2)
		{
		...
		if(es == 0)
		{
			BodyPartsGameobjects.exhaust01.SetActive (true);	BodyPartsGameobjects.exhaust02.SetActive (false); BodyPartsGameobjects.exhaust03.SetActive (false);sp3 = 200;
		}	else sp3 = 0;
		if(es == 1)
		{
